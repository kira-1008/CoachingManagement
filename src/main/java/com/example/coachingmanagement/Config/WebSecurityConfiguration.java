...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/","/login","/logout","/static/","/static/*").permitAll();
        http.authorizeRequests().antMatchers("/self","/self/**","/subjects/","/subjects/**").access("hasAuthority('admin') or hasAuthority('student') or hasAuthority('staff') or hasAuthority('teacher') or hasAuthority('Admin') or hasAuthority('Student') or hasAuthority('Staff') or hasAuthority('Teacher')");
